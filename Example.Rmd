...
target_times <- 10
# Number of bins to discretiz time
nbins_t = 25
# Get discrete data
data_discrete_list <- discretize_time(data, "Ttilde", biased_sampling_indicator = "R", target_times = target_times, nbins_t = nbins_t)
